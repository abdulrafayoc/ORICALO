...
DEFAULT_MODEL_TYPE = os.getenv("LLM_BACKEND", "transformers")

# Model ID
# For transformers: Repo ID (e.g. "microsoft/Phi-3-mini-4k-instruct")
# For llama: Path to GGUF file OR Repo ID (e.g. "mradermacher/Lughaat-1.0-8B-Instruct.Q4_K_M")
DEFAULT_MODEL_ID = os.getenv("LLM_MODEL_ID", "mradermacher/Lughaat-1.0-8B-Instruct-GGUF")
# DEFAULT_MODEL_ID = os.getenv("LLM_MODEL_ID", "mradermacher/Lughaat-1.0-8B-Instruct.Q4_K_M") # Uncomment for Llama
...
4. Answer questions helpfully in Urdu

Rules:
- Respond in concise Urdu (English mixing is acceptable)

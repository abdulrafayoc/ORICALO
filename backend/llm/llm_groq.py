...
from .prompts.voice_agent_ur import VOICE_AGENT_UR
...
class GroqChatbot:
    ...
    def __init__(self, model_name: str = "openai/gpt-oss-20b", api_key: str = None):
        ...
        # Urdu Real Estate Persona Prompt (imported from llm/prompts/voice_agent_ur.py)
        self.system_prompt = VOICE_AGENT_UR
